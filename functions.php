...
require_once get_template_directory() . '/lib/entrymeta.php';         // Entry meta functions goes here
...
require_once get_template_directory() . '/lib/admin/customizer.php';  // Customizer settings
